...
public class KeywordAnnotation_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("com.mycompany.tgni.analysis.uima.annotators.keyword.KeywordAnnotation");
  ...
  public String getTransformedValue(int addr) {
      ...
      jcas.throwFeatMissing("transformedValue", "com.mycompany.tgni.analysis.uima.annotators.keyword.KeywordAnnotation");
