...
public class TextAnnotation_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("com.mycompany.tgni.analysis.uima.annotators.text.TextAnnotation");
  ...
  public String getTagName(int addr) {
      ...
      jcas.throwFeatMissing("tagName", "com.mycompany.tgni.analysis.uima.annotators.text.TextAnnotation");
  ...
  public float getConfidence(int addr) {
      ...
      jcas.throwFeatMissing("confidence", "com.mycompany.tgni.analysis.uima.annotators.text.TextAnnotation");
