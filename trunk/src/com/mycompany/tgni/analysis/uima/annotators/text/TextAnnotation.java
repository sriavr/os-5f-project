...
public class TextAnnotation extends Annotation {
  ...
  public String getTagName() {
    if (TextAnnotation_Type.featOkTst && ((TextAnnotation_Type)jcasType).casFeat_tagName == null)
      jcasType.jcas.throwFeatMissing("tagName", "com.mycompany.tgni.analysis.uima.annotators.text.TextAnnotation");
  ...
  public float getConfidence() {
    if (TextAnnotation_Type.featOkTst && ((TextAnnotation_Type)jcasType).casFeat_confidence == null)
      jcasType.jcas.throwFeatMissing("confidence", "com.mycompany.tgni.analysis.uima.annotators.text.TextAnnotation");
