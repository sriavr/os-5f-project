...
public class SentenceAnnotatorTest {
  ...
  public void testSentenceWithOpenNlp() throws Exception {
    InputStream data = new FileInputStream("/home/sridhar/workspace/UIMAwebapp2/conf/models/en-sent.bin");
  ...
  public void testSentenceAnnotator() throws Exception {
    AnalysisEngine ae = UimaUtils.getAE(
      "/home/sridhar/workspace/UIMAwebapp2/desc/TextMappingAE.xml", null);
    String text = FileUtils.readFileToString(
      new File("/home/sridhar/workspace/UIMAwebapp2/data/sujitpal.blogspot.com.htm"), "UTF-8");
